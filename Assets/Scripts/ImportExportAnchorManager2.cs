...
namespace HoloToolkit.Sharing.Tests
{
    ...
    /// </summary>
    public class ImportExportAnchorManager2 : Singleton<ImportExportAnchorManager2>
    {
        /// <summary>
        ...
        private IEnumerator WaitForWorldAnchorManager()
        {
            if (WorldAnchorManager.Instance == null)
            {
                Debug.Log(">>> WorldAnchorInstance is NULL!");
            }

            Debug.Log(">>> Waiting for WorldAnchorManager");
...
#if UNITY_WSA && !UNITY_EDITOR
            AnchorStoreReady(WorldAnchorManager.Instance.AnchorStore);
#endif
            yield return null;
        }
